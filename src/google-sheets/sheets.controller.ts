...
export class SheetsController {
  ...
  private parseDate(str: string): Date {
    if (!str) return null; // agar bo'sh bo'lsa null qaytaradi
  ...
  async import() {
    try {
      const rows = await this.sheetsService.getSheetRows(); // Google Sheets’dan ma'lumot olish
